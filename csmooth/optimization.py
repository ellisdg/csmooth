...
def graph_smoothing_with_gradient_descent(data, edge_src, edge_dst, edge_distances, fwhm,
    ...
    :param initial_tua: initial value for the smoothing parameter. If None, fwhm is used as the initial value.
...
def find_optimal_tau(fwhm, edge_src, edge_dst, edge_distances, shape, initial_tua=None,
                     max_iterations=100, stop_threshold=0.01, learning_rate=1.0, decay_rate=0.99,
                     random_seed=42):
